...
import 'package:takroom/widgets/listes_view/supplier_order_list_view.dart';
...
class _SupplierOrdersTabState extends State<SupplierOrdersTab> {
  ...
  Widget build(BuildContext context) {
    late List<SupplierOrderModel> orders = [];
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 5),
                            Text(
                              Provider.of<UserProvider>(context).isLodingBalance
                                  ? "?????"
                                  : Provider.of<UserProvider>(
                                      context,
                                    ).user!.balance,
              ...
              children: [
                ...
                MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    orders = await SupplierOrderService.getSupplierOrders(
                      Provider.of<UserProvider>(
                        context,
                        listen: false,
                      ).user!.token,
