...
class BanAccountDialog extends StatefulWidget {
  final int userId;
  final String userName;

  const BanAccountDialog({
    super.key,
  ...
  @override
  State<BanAccountDialog> createState() => _BanAccountDialogState();
}

class _BanAccountDialogState extends State<BanAccountDialog> {
  ...
  Future<void> _banAccount() async {
    try {
      ...
      final message = await AdminService.banUser(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "This user will be prevented from using the application.",
                ...
                Text(
                  "You can unban the account later.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: isLoading ? null : _banAccount,
                          child: isLoading
                              ? const SizedBox(
                                  width: 24,
                                  height: 24,
