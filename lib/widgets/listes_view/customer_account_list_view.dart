...
import 'package:takroom/widgets/dialogs/deposite_to_customer_dialog.dart';
import 'package:takroom/widgets/dialogs/unban_account_dialog.dart';

class CustomerAccountListView extends StatefulWidget {
  const CustomerAccountListView({super.key});

  @override
  State<CustomerAccountListView> createState() =>
      _CustomerAccountListViewState();
}

class _CustomerAccountListViewState extends State<CustomerAccountListView> {
  @override
  void initState() {
    super.initState();
                      ...
                      onPressed: () {
                        showGeneralDialog(
                          ...
                          pageBuilder: (_, __, ___) {
                            return DepositToCustomerDialog(
